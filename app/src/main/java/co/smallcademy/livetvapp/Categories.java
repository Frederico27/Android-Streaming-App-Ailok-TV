...
public class Categories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Kategoria");
        ...
        dataService.getChannelData("https://ailoktv.000webhostapp.com/api.php?key=1A4mgi2rBHCJdqggsYVx&id=1&categories=all", new ChannelDataService.OnDataResponse() {
            @Override
            public void onResponse(JSONObject response) {
                for(int i = 0; i<response.length();i++){
                    try {
                        ...
                        if(!categoryName.equals("Youtube")) {
